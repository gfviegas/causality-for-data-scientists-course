...
\begin{frame}{Materiais Extras}
	\begin{itemize}
		...
		\href{https://www.stats.ox.ac.uk/~evans/gms/_book/}{Livro Online}
		\vspace{10pt}
		\item \textbf{Notebook extra} --- \texttt{5\_heterogeneous\_effects.ipynb} \\
		CATE com meta-learners (S/T/X-learner) e uma política de tratamento personalizada
		\vspace{10pt}
		\item \textbf{Notebook extra} --- \texttt{7\_counterfactual\_explanations.ipynb} \\
